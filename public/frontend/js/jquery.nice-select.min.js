				...
				.html(i.data("display") || i.text()), n.each(function (t) {
					...
					s.find("ul")
						.append(e("<li></li>")
							...
							.addClass("option" + (n.is(":selected") ? " selected" : "") + (n.is(
								":disabled") ? " disabled" : ""))
							.html(n.text()))
				})
		}
		if ("string" == typeof t) return "update" == t ? this
			.each(function () {
				var t = e(this),
					n = e(this)
						.next(".nice-select"),
		...
		this.hide(), this.each(function () {
			...
			.off(".nice_select"), e(document)
				.on("click.nice_select", ".nice-select", function (t) {
					...
					e(".nice-select")
						.not(s)
						.removeClass("open"), s.toggleClass("open"), s.hasClass("open") ? (s.find(
							".option"), s.find(".focus")
					...
					.on("click.nice_select", function (t) {
						...
						.on("click.nice_select", ".nice-select .option:not(.disabled)", function (t) {
							...
							.on("keydown.nice_select", ".nice-select", function (t) {
								...
								if (32 == t
									.keyCode || 13 == t.keyCode) return s.hasClass("open") ? n.trigger("click") : s
										.trigger("click"), !1;
								if (40 == t.keyCode) {
									if (s.hasClass("open")) {
										var i = n
								...
								if (27 == t.keyCode) s.hasClass("open") && s.trigger(
									"click");

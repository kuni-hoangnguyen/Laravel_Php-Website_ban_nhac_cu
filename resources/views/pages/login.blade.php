    ...
    <section class="forms-section">
        <div class="forms">
            <div class="form-wrapper {{ $form_active == 'form-login' ? 'is-active' : '' }}">
                ...
                <form class="form form-login" action="{{ URL::to('/login') }}" method="POST" name="form-login">
                    @csrf
                    <fieldset>
            ...
            <div class="form-wrapper {{ $form_active == 'form-sign-up' ? 'is-active' : '' }}">
                ...
                <form class="form form-signup" action="{{ URL::to('/sign-up') }}" method="POST" name="form-sign-up">
                    @csrf
                    <fieldset>
